...
from graphrag.core.config import Source
...
class LocalIngestor(Ingestor):
    ...
    This is the concrete implementation that ships with the toolkit; the
    abstract `Ingestor` above is the open extension point (specialise it for
    other sources). Co-located in this module because the interface and its
    bundled implementation are one cohesive unit.
    """
